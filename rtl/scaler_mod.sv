...
wire [MODULUS_WIDTH+1  : 0] t3    = {oprnd_x, 1'b0}  + oprnd_x;   // 3x
wire [MODULUS_WIDTH+2  : 0] t7    = {oprnd_x, 3'b0}  - oprnd_x;   // 7x
wire [MODULUS_WIDTH+7  : 0] t231  = {t7, 5'b0}       + t7;        // 231x
wire [MODULUS_WIDTH+11 : 0] mul_c = {t3, 10'b0}      + t231;      // 3303x
